...
export function middleware(_req: NextRequest) {
  ...
  const csp = [
    ...
    "font-src 'self' data:",
    "connect-src 'self' https://*.supabase.co https://api.hume.ai wss://api.hume.ai https://api.heygen.com https://*.cloudflare.com https://static.cloudflareinsights.com https://vercel.live https://challenges.cloudflare.com",
