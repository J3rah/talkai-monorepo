...
import { CalendarDays, Clock, User, ArrowLeft, DollarSign, Target, CheckCircle, TrendingUp, Brain } from 'lucide-react';

export const metadata: Metadata = {
  title: 'When Money Is Tight: Coping with Financial Stress via TalkAI',
  description:
    'Ground anxiety around money with TalkAI: triage tasks, emotional regulation, and practical next steps.',
  keywords: [
    'financial stress',
    'money anxiety',
    'TalkAI financial',
  ...
  openGraph: {
    title: 'When Money Is Tight: Coping with Financial Stress via TalkAI',
    description:
      'Financial stress is emotionally and cognitively heavy. TalkAI helps you separate feelings from actions.',
    type: 'article',
    images: ['/og-image.png'],
  ...
  twitter: {
    ...
    title: 'When Money Is Tight: Coping with Financial Stress via TalkAI',
    description: 'Regulate first, plan second—manage money stress with TalkAI.',
        ...
        <article className="max-w-4xl mx-auto">
          ...
          <header className="mb-12">
            <div className="flex items-center gap-2 mb-4">
              <Badge variant="secondary" className="bg-green-100 text-green-800">Financial Wellness</Badge>
              <Badge variant="outline">New</Badge>
            </div>

            <h1 className="text-4xl md:text-5xl font-bold text-slate-900 dark:text-white mb-6 leading-tight">
              When Money Is Tight: Coping with Financial Stress via TalkAI
            </h1>

            <p className="text-xl text-slate-600 dark:text-slate-300 mb-8 leading-relaxed">
              Financial stress is emotionally and cognitively heavy. TalkAI helps you separate feelings from actions and
          ...
          <div className="prose prose-lg max-w-none dark:prose-invert">
              ...
              <Card className="bg-gradient-to-r from-blue-600 to-purple-600 text-white">
                <CardContent className="pt-6">
                  ...
                  <ul className="space-y-2">
                    ...
                    <li>• Self-talk: "I can act one step at a time"</li>
                  </ul>
                </CardContent>
              </Card>
            </section>
            ...
            <section id="triage" className="mb-12">
              ...
              <Card>
                <CardContent className="pt-6">
                  <p className="mb-4">List obligations and mark priorities:</p>
                  <ul className="space-y-2">
                    <li>• Must-dos for next 72 hours</li>
                    <li>• Could-dos for next week</li>
                    <li>• Nice-to-dos for later</li>
                    <li>• Focus on immediate priorities</li>
                  </ul>
                </CardContent>
              </Card>
            </section>
            ...
            <section id="action" className="mb-12">
              ...
              <Card>
                <CardContent className="pt-6">
                  <p className="mb-4">One small step at a time:</p>
                  <ul className="space-y-2">
                ...
                <CardContent className="pt-6">
                  <ul className="space-y-3">
                    <li className="flex items-start gap-3">
                      ...
                      <span>Note what reduced stress most</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle className="w-5 h-5 text-green-600 mt-1" />
                      <span>Repeat helpful strategies</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle className="w-5 h-5 text-green-600 mt-1" />
                      <span>Celebrate small progress</span>
                    </li>
                  </ul>
                </CardContent>
              </Card>
            ...
            <section id="cta" className="mb-12">
              ...
              <Card className="bg-gradient-to-r from-blue-600 to-purple-600 text-white mb-8">
                <CardContent className="pt-6">
                  ...
                  <p className="mb-6">Separate feelings from actions during stressful financial moments.</p>
