...
export const metadata: Metadata = {
  ...
  description: "Sleep quality shapes our emotional regulation, memory, and focus. When we’re short on rest, the amygdala becomes more reactive and the prefrontal cortex less…",
  openGraph: {
    title: 'Sleep as Emotional First Aid | talkAI',
    description: "Sleep quality shapes our emotional regulation, memory, and focus. When we’re short on rest, the amygdala becomes more reactive and the prefrontal cortex less…",
    type: 'article'
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <article className="max-w-4xl mx-auto">
          <header className="mb-8">
            ...
            <p className="text-slate-600 dark:text-slate-300">Sleep quality shapes our emotional regulation, memory, and focus. When we’re short on rest, the amygdala becomes more reactive and the prefrontal cortex less…</p>
          </header>

          <div className="prose prose-lg max-w-none dark:prose-invert">
<p>Sleep quality shapes our emotional regulation, memory, and focus. When we’re short on rest, the amygdala becomes more reactive and the prefrontal cortex less effective—hello, mood swings.</p>
