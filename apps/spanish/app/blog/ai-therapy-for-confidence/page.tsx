...
import { CalendarDays, Clock, User, ArrowLeft, CheckCircle, Brain, Heart, Shield, Star, Zap, Target } from 'lucide-react';
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'AI Therapy for Confidence',
    description: 'Learn how AI therapy can help you build confidence and improve self-esteem.',
    type: 'article',
        ...
        <article className="max-w-4xl mx-auto">
          <header className="mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-slate-900 dark:text-white mb-6 leading-tight">
              AI Therapy for Confidence: Building Self-Esteem and Personal Power
            </h1>
            
            <p className="text-xl text-slate-600 dark:text-slate-300 mb-8 leading-relaxed">
              Discover how AI therapy can help you build unshakeable confidence, improve self-esteem, 
          ...
          <div className="prose prose-lg max-w-none">
            <section className="mb-12">
              <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-6">The Power of Confidence and Self-Esteem</h2>
              <p className="text-slate-600 dark:text-slate-300 mb-6">
                Confidence is the foundation of success in all areas of life. AI therapy provides 
                personalized tools and techniques to help you build lasting confidence and self-esteem.
              </p>
            </section>

            <section className="mb-12">
              <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-6">AI Therapy Solutions for Confidence Building</h2>
                ...
                <Card className="bg-yellow-50 dark:bg-yellow-950 border-yellow-200">
                  ...
                  <CardContent>
                    <p className="text-yellow-700 dark:text-yellow-300">
                      Develop a positive self-image and build unshakeable self-esteem.
                    </p>
                  </CardContent>
                </Card>
              ...
              <Card className="bg-gradient-to-r from-yellow-50 to-orange-50 dark:from-yellow-950 dark:to-orange-950 border-yellow-200">
                ...
                <CardContent>
                  <p className="text-yellow-700 dark:text-yellow-300 mb-4">
                    Start your journey toward confidence and self-esteem with TalkAI's AI-powered therapy platform.
                  </p>
