    ...
    <div className="max-w-4xl mx-auto p-6">
      ...
      <div className="space-y-8 text-gray-700 dark:text-gray-300">
        ...
        <section>
          ...
          <div className="bg-muted/50 dark:bg-muted/30 border border-border rounded-lg p-4 mb-4">
            <h3 className="text-lg font-semibold text-foreground mb-2">⚠️ If You Are in Crisis</h3>
