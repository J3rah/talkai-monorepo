...
const auth_configs_1 = require("./resources/auth-configs.js");
const cli_1 = require("./resources/cli.js");
const connected_accounts_1 = require("./resources/connected-accounts.js");
const files_1 = require("./resources/files.js");
const link_1 = require("./resources/link.js");
const migration_1 = require("./resources/migration.js");
const team_members_1 = require("./resources/team-members.js");
const toolkits_1 = require("./resources/toolkits.js");
const tools_1 = require("./resources/tools.js");
const triggers_types_1 = require("./resources/triggers-types.js");
...
const mcp_1 = require("./resources/mcp/mcp.js");
const org_1 = require("./resources/org/org.js");
const trigger_instances_1 = require("./resources/trigger-instances/trigger-instances.js");
const environments = {
...
class Composio {
     ...
     */
    constructor({ baseURL = (0, env_1.readEnv)('COMPOSIO_BASE_URL'), apiKey = (0, env_1.readEnv)('COMPOSIO_API_KEY') ?? null, ...opts } = {}) {
        _Composio_instances.add(this);
        _Composio_encoder.set(this, void 0);
        this.authConfigs = new API.AuthConfigs(this);
        this.connectedAccounts = new API.ConnectedAccounts(this);
        this.link = new API.Link(this);
        this.org = new API.Org(this);
        this.teamMembers = new API.TeamMembers(this);
        this.toolkits = new API.Toolkits(this);
        this.tools = new API.Tools(this);
        this.triggerInstances = new API.TriggerInstances(this);
        this.triggersTypes = new API.TriggersTypes(this);
        this.mcp = new API.Mcp(this);
        this.files = new API.Files(this);
        this.migration = new API.Migration(this);
        this.cli = new API.Cli(this);
        const options = {
            apiKey,
            ...opts,
            baseURL,
        ...
        if (baseURL && opts.environment) {
            throw new Errors.ComposioError('Ambiguous URL; The `baseURL` option (or COMPOSIO_BASE_URL env var) and the `environment` option are given. If you want to use the environment you must pass baseURL: null');
        }
        ...
        this.logLevel =
            (0, log_1.parseLogLevel)(options.logLevel, 'ClientOptions.logLevel', this) ??
                (0, log_1.parseLogLevel)((0, env_1.readEnv)('COMPOSIO_LOG'), "process.env['COMPOSIO_LOG']", this) ??
                defaultLogLevel;
        this.fetchOptions = options.fetchOptions;
        this.maxRetries = options.maxRetries ?? 2;
        this.fetch = options.fetch ?? Shims.getDefaultFetch();
        tslib_1.__classPrivateFieldSet(this, _Composio_encoder, Opts.FallbackEncoder, "f");
    ...
    buildURL(path, query, defaultBaseURL) {
        const baseURL = (!tslib_1.__classPrivateFieldGet(this, _Composio_instances, "m", _Composio_baseURLOverridden).call(this) && defaultBaseURL) || this.baseURL;
    ...
    buildBody({ options: { body, headers: rawHeaders } }) {
        ...
        ArrayBuffer.isView(body) ||
            ...
            return tslib_1.__classPrivateFieldGet(this, _Composio_encoder, "f").call(this, { body, headers });
        }
    }
}
...
Composio.ComposioError = Errors.ComposioError;
Composio.APIError = Errors.APIError;
Composio.APIConnectionError = Errors.APIConnectionError;
Composio.APIConnectionTimeoutError = Errors.APIConnectionTimeoutError;
Composio.APIUserAbortError = Errors.APIUserAbortError;
Composio.NotFoundError = Errors.NotFoundError;
Composio.ConflictError = Errors.ConflictError;
Composio.RateLimitError = Errors.RateLimitError;
Composio.BadRequestError = Errors.BadRequestError;
Composio.AuthenticationError = Errors.AuthenticationError;
Composio.InternalServerError = Errors.InternalServerError;
Composio.PermissionDeniedError = Errors.PermissionDeniedError;
Composio.UnprocessableEntityError = Errors.UnprocessableEntityError;
Composio.toFile = Uploads.toFile;
Composio.AuthConfigs = auth_configs_1.AuthConfigs;
Composio.ConnectedAccounts = connected_accounts_1.ConnectedAccounts;
Composio.Link = link_1.Link;
Composio.Org = org_1.Org;
Composio.TeamMembers = team_members_1.TeamMembers;
Composio.Toolkits = toolkits_1.Toolkits;
Composio.Tools = tools_1.Tools;
Composio.TriggerInstances = trigger_instances_1.TriggerInstances;
Composio.TriggersTypes = triggers_types_1.TriggersTypes;
Composio.Mcp = mcp_1.Mcp;
Composio.Files = files_1.Files;
Composio.Migration = migration_1.Migration;
Composio.Cli = cli_1.Cli;
