...
export interface AuthConfigRetrieveResponse {
     ...
     */
    auth_scheme?: 'OAUTH2' | 'OAUTH1' | 'API_KEY' | 'BASIC' | 'BILLCOM_AUTH' | 'BEARER_TOKEN' | 'GOOGLE_SERVICE_ACCOUNT' | 'NO_AUTH' | 'BASIC_WITH_JWT' | 'CALCOM_AUTH';
    /**
...
//# sourceMappingURL=auth-configs.d.ts.map