...
__export(index_exports, {
  ...
  ComposioFailedToCreateConnectedAccountLink: () => ComposioFailedToCreateConnectedAccountLink,
  ...
  CreateConnectedAccountLinkOptionsSchema: () => CreateConnectedAccountLinkOptionsSchema,
  CreateConnectedAccountLinkResponseSchema: () => CreateConnectedAccountLinkResponseSchema,
...
var ToolSchema = import_zod3.z.object({
  ...
  tags: import_zod3.z.array(import_zod3.z.string()).describe("The tags of the tool. eg: Important").default([]).optional(),
  toolkit: ToolkitSchema.describe("The toolkit of the tool").optional(),
  version: import_zod3.z.string().describe('The version of the tool, e.g. "20250909_00"').optional(),
  availableVersions: import_zod3.z.array(import_zod3.z.string()).describe("Available versions of the tool.").default([]).optional(),
  scopes: import_zod3.z.array(import_zod3.z.string()).describe('The scopes of the tool. eg: ["task:add"]').optional()
});
...
var ToolExecuteParamsSchema = import_zod3.z.object({
  ...
  version: import_zod3.z.union([import_zod3.z.literal("latest"), import_zod3.z.string()]).optional(),
...
var CreateConnectedAccountLinkOptionsSchema = import_zod6.z.object({
  /**
...
var CreateConnectedAccountLinkResponseSchema = import_zod6.z.object({
  redirectUrl: import_zod6.z.string()
});
