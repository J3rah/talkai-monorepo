...
export const metadata: Metadata = {
  title: 'What is AI Therapy? Complete Guide to Artificial Intelligence in Mental Health 2024',
  description: 'Discover how AI therapy works, its benefits, limitations, and why it\'s revolutionizing mental health support. Learn if AI therapy is right for you with our comprehensive guide.',
  keywords: [
    'what is AI therapy',
  ...
  openGraph: {
    title: 'What is AI Therapy? Complete Guide to AI Mental Health Support',
    description: 'Learn everything about AI therapy - how it works, benefits, limitations, and whether it\'s right for you. Complete guide to AI mental health support.',
    type: 'article',
  ...
  twitter: {
    ...
    title: 'What is AI Therapy? Complete Guide to AI Mental Health',
    description: 'Comprehensive guide to AI therapy - how it works, benefits, and whether it\'s right for you.',
        ...
        <article className="max-w-4xl mx-auto">
          ...
          <header className="mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-slate-900 dark:text-white mb-6 leading-tight">
              What is AI Therapy? A Complete Guide to Artificial Intelligence in Mental Health
            </h1>
            
            <p className="text-xl text-slate-600 dark:text-slate-300 mb-8 leading-relaxed">
              Discover how AI therapy works, its benefits, limitations, and why it's revolutionizing mental health support. 
              Learn if AI therapy is right for you with our comprehensive, evidence-based guide.
            </p>
          ...
          <Card className="mb-12 bg-blue-50 dark:bg-slate-800 border-blue-200">
            ...
            <CardContent>
              <ul className="space-y-2">
                <li><a href="#what-is-ai-therapy" className="text-blue-600 hover:underline">What is AI Therapy?</a></li>
                <li><a href="#how-it-works" className="text-blue-600 hover:underline">How Does AI Therapy Work?</a></li>
                <li><a href="#benefits" className="text-blue-600 hover:underline">Key Benefits of AI Therapy</a></li>
                <li><a href="#types" className="text-blue-600 hover:underline">Types of AI Therapy</a></li>
                <li><a href="#effectiveness" className="text-blue-600 hover:underline">Is AI Therapy Effective?</a></li>
                <li><a href="#limitations" className="text-blue-600 hover:underline">Limitations and Considerations</a></li>
                <li><a href="#getting-started" className="text-blue-600 hover:underline">Getting Started with AI Therapy</a></li>
              </ul>
            </CardContent>
          </Card>
          ...
          <div className="prose prose-lg max-w-none dark:prose-invert">
            ...
            <section id="how-it-works" className="mb-12">
              <h2 className="text-3xl font-bold mb-6">How Does AI Therapy Work?</h2>
            ...
            <section id="types" className="mb-12">
              <h2 className="text-3xl font-bold mb-6">Types of AI Therapy</h2>
            ...
            <section id="effectiveness" className="mb-12">
              <h2 className="text-3xl font-bold mb-6">Is AI Therapy Effective?</h2>
            ...
            <section id="getting-started" className="mb-12">
              <h2 className="text-3xl font-bold mb-6">Getting Started with AI Therapy</h2>
              
              <Card className="bg-gradient-to-r from-blue-600 to-purple-600 text-white mb-8">
                <CardContent className="pt-6">
                  <h3 className="text-xl font-semibold mb-4">Ready to Try AI Therapy?</h3>
                  <p className="mb-6">
                    TalkAI provides empathetic, voice-based AI therapy that's available 24/7. Start your mental health 
                    journey with a free trial and experience the future of accessible mental health support.
                  </p>
                  <Link 
                    href="/auth" 
