...
var ComposioLinkConnectionDataSchema = z2.discriminatedUnion("status", [
...
var ConnectionDataSchema = z2.discriminatedUnion("authScheme", [
  ...
  z2.object({
    authScheme: z2.literal(AuthSchemeTypes.COMPOSIO_LINK),
    /**
     * the main connection data discriminated by auth scheme
     */
...
var ToolSchema = z3.object({
  ...
  tags: z3.optional(z3.array(z3.string())).describe("The tags of the tool. eg: Important").default([]),
  toolkit: z3.optional(ToolkitSchema).describe("The toolkit of the tool"),
  version: z3.optional(z3.string()).describe('The version of the tool, e.g. "1.0.0"'),
  scopes: z3.optional(z3.array(z3.string())).describe('The scopes of the tool. eg: ["task:add"]')
});
